...
VALUES
(500, 'Silas do Reino', 'Human', 2, 0),
(501, 'Gabriel da Madrugada', 'Human', 3, 0);

INSERT INTO `senhor_aneis`.`missoes`
(`id`, `descricao`, `valor_diaria`, `qtde_dias`)
VALUES
(110, 'Acordar Cedo', 50000, 365);
